...
\begin{frame}{Calcification}
    ...
    \includegraphics<1|handout:0>[totalheight=0.7\textheight, keepaspectratio]{carbon-gastropod.jpg}
    \includegraphics<1|handout:0>[totalheight=0.7\textheight, keepaspectratio]{carbon-reef.jpg}

    \includegraphics<2|handout:1>[width=\linewidth, totalheight=0.8\textheight, keepaspectratio]{carbon-calcifiers.png}
...
\begin{frame}{1. Parameterise \ce{CacO3} Export}
    ...
    $$
    \dv{DIC_{calc, i}}{t} = \dv{\ce[CO_3^{2-}]_{calc, i}}{t} = f_{calc} 106 \frac{V_i}{\tau^P_i} P_i
    $$
...
\begin{frame}{Impact of Carbonate Pump}
    ...
    \only<2|handout:1>{$\mathrm{pCO_2} \sim 354$}
    ...
    \only<3|handout:2>{$\mathrm{pCO_2} \sim 418$!}
