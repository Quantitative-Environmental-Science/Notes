...
\begin{frame}{How much carbon is in the ocean?}
    \begin{columns}
        ...
        \begin{column}{0.7\linewidth}
            \includegraphics[width=\linewidth, totalheight=0.8\textheight, keepaspectratio]{pacific.jpg}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Lab Report}
    \begin{itemize}
        ...
        \item 1500 words
        \item Due \textbf{Sunday 12th April}
        \begin{itemize}
            ...
            \item Detailed instructions and marking guide are on Moodle.
        \end{itemize} 
    \end{itemize}
\end{frame}
...
\begin{frame}{Ocean \& Atmosphere}
    ...
    \begin{tikzpicture}
        \node[inner sep=0] (img) {
            \includegraphics[width=\linewidth, totalheight=0.75\textheight, keepaspectratio]{carbon-1box.png}
        };
        \node[anchor=south east, align=right, font=\normalsize] at (
            [xshift=-0.4cm, yshift=0.6cm]img.south east) {
            71\% of Earth SA \\
            3.7 km deep \\
            $1.4 \times 10^{21}~\mathrm{kg}$
        };
    \end{tikzpicture}
...
\begin{frame}{Henry's Law}
    ...
    \only<2>{
        \manualpic{carbon-janco2-2026.png}{width=4cm}{5.5cm}{-1.5cm}
    }
...
\begin{frame}{Modelling Ocean Carbon}
    ...
    \only<1|handout:1>{
        In \textbf{Practicals L4-6} you will be making a model of carbon in the ocean. \\
        ~ \\
