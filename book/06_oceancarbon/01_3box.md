...
As of Feb 2026, [the atmosphere contains 428.6 ppm CO<sub>2</sub>](https://www.esrl.noaa.gov/gmd/ccgg/trends/) (up by 2 ppm from last year).
...
3. **Biological processes** in the surface ocean turn dissolved carbon into solid matter and transport it to the deep ocean, where it cannot equilibrate with the atmosphere.
