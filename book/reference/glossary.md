...
Aquiclude
: Sometime refered to as an *aquifuge*; a rock with very low {term}`hydraulic conductivity` that acts as an impermeable barrier to groundwater flow.
...
Artisan Well
: A well that flows without pumping because the hydraulic head in the {term}`confined aquifer<Confined Aquifer>` that feeds it is greater than that at ground level.
...
Eutrophication
: The process by which a body of water becomes enriched in nutrients (notably nitrogen and phosphorus), leading to excessive growth of algae and depletion of oxygen.
...
Reynolds Number
: The ratio of inertial forces to viscous forces within a fluid. Fluids with a large Reynolds Number are dominated by inertial forces, and fluids with a small Reynolds Number are dominated by viscous drag.
...
Water Table
: The upper surface of groundwater, or the level below which an {term}`aquifer` is permanently saturated with water.
